       ...
       <div id="info" class="tab_content">
		...
		<div class="formRow">
			...
			<div class="formRight">
                ...
                <div class="note">  
				<?php if($_REQUEST['type']=='slider')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:545px '; ?>
                 
                <?php if($_REQUEST['type']=='slider3')echo 'Width:600px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:160px '; ?> 
                
                <?php if($_REQUEST['type']=='slide_index')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:260px '; ?> 
                
                <?php if($_REQUEST['type']=='hiephoi' || $_REQUEST['type']=='doitac')echo 'Width:195px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:140px '; ?>
